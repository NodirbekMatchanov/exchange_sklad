...
use rare\exchange1c\assets\AppAsset;
use rare\exchange1c\widgets\Menu;
...
$ico = $this->assetManager->publish('@vendor/rare/yii2-1c-exchange/assets/other/favicon.ico');
$this->beginPage();
?>
<!DOCTYPE html>
<html>
