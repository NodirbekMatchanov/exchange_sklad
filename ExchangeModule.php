...
class ExchangeModule extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'rare\exchange1c\controllers';
    /**
     * Модель продукта
     *
     * @var \rare\exchange1c\interfaces\ProductInterface
     */
    public $productClass;
    /**
     * Модель предложения
     *
     * @var \rare\exchange1c\interfaces\OfferInterface
     */
    public $offerClass;
    /**
     * Модель документа
     ...
     *
     * @var \rare\exchange1c\interfaces\GroupInterface
     */
    public $groupClass;
    /**
     * Модель пользователя
     *
     * @var \rare\exchange1c\interfaces\PartnerInterface
     */
    public $partnerClass;
    /**
     * Модель склада
     *
     * @var \rare\exchange1c\interfaces\WarehouseInterface
     */
    ...
    public $redactorModuleName = 'rare-exchange-redactor';
    /**
    ...
    private function loadRedactorModule()
    {
        ...
        if (class_exists($redactorClass) && !Yii::$app->getModule($moduleRedactorName)) {
            ...
            \Yii::$app->setModule($moduleRedactorName, [
                ...
                'uploadDir' => '@vendor/rare/yii2-1c-exchange/files/articles',
