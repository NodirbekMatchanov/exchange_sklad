...
use rare\exchange1c\models\base\Article as BaseArticle;
use rare\exchange1c\models\query\ArticleQuery;
use Yii;
...
class Article extends BaseArticle
{
    ...
    public static function formContentItems($parent = null)
    {
        ...
        foreach ($query->each() as $article) {
            if ($article->content) {
                $link = 'https://raw.github.com/rare/yii2-1c-exchange/HEAD/files/articles';
