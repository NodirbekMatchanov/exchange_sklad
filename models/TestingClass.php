...
use rare\exchange1c\helpers\ClassHelper;
 ...
 * Class TestingClass
 *
 * @package rare\exchange1c\models
...
abstract class TestingClass extends Testing
{
    ...
    protected static function getParams($params)
    {
        ...
        foreach ($params as $param) {
            $value = null;
            $cml = new CommerceML();
            $cml->loadImportXml(\Yii::getAlias('@vendor/rare/yii2-1c-exchange/files/xml/import.xml'));
            $cml->loadOffersXml(\Yii::getAlias('@vendor/rare/yii2-1c-exchange/files/xml/offers.xml'));
